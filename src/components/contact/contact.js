    ...
    <div className="contact animate__animated animate__fadeInUp">
      <div>
        <img
          ...
          alt="svgImg"
          onClick={() => {
            window.open("https://www.linkedin.com/in/gary-zhang-b3961519a/");
          }}
        ...
        <img
          ...
          alt="svgImg"
          onClick={() => {
            window.open("https://github.com/GaryJC");
          }}
        ...
        <img
          ...
          alt="svgImg"
          onClick={() => {
            window.open("mailto:garyjiacheng@gmail.com");
          }}
        ...
        <img
          ...
          onClick={() => {
            window.open(
              "https://www.facebook.com/profile.php?id=100077472181545"
            );
          }}
